(function (global, factory) {
	...
	const NoLane = 0b000;
	const NoLanes = 0b000;
	function mergeLanes(laneA, lanB) {
	    return laneA | lanB;
	}
	...
	function createSyntheicEvent(e) {
	    const syntheicEvent = e;
	...
	function ChildReconclier(shouldTrackEffects) {
	    ...
	    function reconclieSingleElement(returnFiber, currentFiber, element) {
	    ...
	    return function reconcileChildFibers(returnFiber, currentFiber, newChild) {
	        ...
	        if (typeof newChild === 'object' && newChild !== null) {
	            ...
	            switch (newChild.$$typeof) {
	                case REACT_ELEMENT_TYPE:
	                    return placeSingleChild(reconclieSingleElement(returnFiber, currentFiber, newChild));
	                default:
	                    {
	...
	const reconcileChildFibers = ChildReconclier(true);
	const mountChildFibers = ChildReconclier(false);
	...
	function arteHookInputsEqual(nextDeps, prevDeps) {
	...
	function updateState() {
	    ...
	    if (pending !== null) {
	        const { memeizedState } = processUpdateQueue(hook.memoizedState, pending, renderLane);
	...
	function updateFunctionConponent(wip, renderLane) {
	...
	let nextEffect = null;
	const commitMutaionEffects = (finishedWork, root) => {
	...
	function markUpdateFromFiberRoRoot(fiber) {
	    let node = fiber;
